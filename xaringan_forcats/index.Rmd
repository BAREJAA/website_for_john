...
```{r panelset = TRUE}
happy_full %>% 
  ggplot(aes(fct_reorder(region, ladder_score), ladder_score)) + #<<
  geom_boxplot() +
  coord_flip()
```
]
...
```{r panelset = TRUE}
happy_full %>% 
  ggplot(aes(fct_reorder(region, ladder_score, .desc = TRUE), ladder_score)) + #<<
  geom_boxplot() +
  coord_flip()
```
]
...
```{r panelset = TRUE}
happy_full %>% 
  ggplot(aes(fct_reorder(region, ladder_score, .fun = mean), ladder_score)) + #<<
  geom_boxplot() +
  coord_flip()
```
]

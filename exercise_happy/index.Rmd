...
What does the `ladder_score` distribution look like for each region? There are many ways to viualize this. Let's first plot all the distributions on one plot

...
ADD ./_site /srv/code
RUN install2.r metathis distill learnr knitr here rlang ggrepel viridis gghighlight twitterwidget patchwork mixOmics glue devtools ggforce readxl lubridate xaringan xaringanthemer kableExtra janitor
RUN apt-get update

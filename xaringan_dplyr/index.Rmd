...
--
For this module, we will use a dataset called **happy**  
--
...
```
--     
The code chunk above takes all the elements of the column `gdp`, evaluates the square root of each element, and populates a new column called `gdp_sqrt` with these results
---
class: center, middle
...
To show off the power of this duo, let's take a look at the entire dataset - called `happy_full` - that contains an additional columns, one of which is called `region`  
